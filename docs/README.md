...
Then [2026-09-18 int8 schedule search](results/2026-09-18-int8-schedule.md) (at an iso 30k budget,
annealing the sign step linearly to *zero* beats every other endpoint and cosine: 1.0181 ± 0.0010
over three seeds, 0.035 from QAT, **56% of the master-weight-free gap recovered**).
